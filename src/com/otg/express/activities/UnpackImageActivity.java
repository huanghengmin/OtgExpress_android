...
public class UnpackImageActivity extends Activity {
    private ImageView img;
    private ImageButton imageButton;
    private ImageButton imageButtonReset;
    private ExpressLog expressLog;
    private Context context;
    public static final String jpgfile = "unpack.jpg";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (expressLog != null/*&&expressLog.getUnpack_img()!=null*/) {
                    Intent i = new Intent(context, FaceImageActivity.class);
                    i.putExtra("expressLog", expressLog);
                    startActivity(i);
                    finish();
                } else {
                    new AlertDialog.Builder(context).setTitle("提示")//设置对话框标题
                            .setMessage("请重拍开箱照！")//设置显示的内容
                            .setNegativeButton("返回", new DialogInterface.OnClickListener() {//添加返回按钮
                                @Override
                                public void onClick(DialogInterface dialog, int which) {//响应事件
                                    Log.i("alert dialog", " 请重拍开箱照！");
                                }
                            }).show();//在按键响应事件中显示此对话框
                }
            }
                ...
                case 1:
                    ...
                    if (f.exists()) {
                        ...
                        if (null != camorabitmap) {
                            ...
                            if (expressLog != null) {
                                expressLog.setUnpack_img(bytes);
                            } else {
