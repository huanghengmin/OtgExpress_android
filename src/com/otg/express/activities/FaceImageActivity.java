...
public class FaceImageActivity extends Activity {
    private ImageView img;
    private ImageButton imageButton;
    private ImageButton imageButtonReset;
    private ExpressLog expressLog;
    private Context context;
    public static final String jpgfile = "face.jpg";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (expressLog != null /*&& expressLog.getFace_img() != null*/) {
